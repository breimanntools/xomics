...
version = "latest"
release = '2023'
repository_url = "https://github.com/breimanntools/xomics"
...
man_pages = [
    (master_doc, "xomics", "xOmics Documentation", [author], 1)
]

# -- Options for Texinfo output -------------------------------------------
texinfo_documents = [
    (master_doc, "xOmics", "xOmics Documentation", author, "xOmics",
...
_module_path = os.path.dirname(importlib.util.find_spec("xomics").origin)  # type: ignore
...
def linkcode_resolve(domain, info):
    ...
    try:
        ...
        url_path = f"{repository_url}/tree/master/xomics/{relative_path}#L{lineno}-L{lineno + len(src) - 1}"
        return url_path
