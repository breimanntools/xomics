...
class TestPlotSetLegend:
    ...
    def test_invalid_marker(self, marker, dict_color):
        ...
        if marker not in valid_markers:
            with pytest.raises(ValueError):
                xo.plot_legend(ax=self.ax, dict_color=dict_color, marker=marker)
    ...
    def test_plot_set_legend_ncol(self, ncol, dict_color):
        ...
        ax = plt.gca()
        result = xo.plot_legend(ax=ax, ncol=ncol, dict_color=dict_color)
    ...
    def test_plot_set_legend_labelspacing(self, labelspacing, dict_color):
        ...
        ax = plt.gca()
        result = xo.plot_legend(ax=ax, labelspacing=labelspacing, dict_color=dict_color)
        assert isinstance(result, plt.Axes)
    ...
    def test_plot_set_legend_columnspacing(self, columnspacing, dict_color):
        ...
        ax = plt.gca()
        result = xo.plot_legend(ax=ax, columnspacing=columnspacing, dict_color=dict_color)
        assert isinstance(result, plt.Axes)
    ...
    def test_plot_set_legend_handletextpad(self, handletextpad, dict_color):
        ...
        ax = plt.gca()
        result = xo.plot_legend(ax=ax, handletextpad=handletextpad, dict_color=dict_color)
        assert isinstance(result, plt.Axes)
    ...
    def test_legend_positioning(self, dict_color):
        ...
        ax = plt.gca()
        result = xo.plot_legend(ax=ax, loc_out=True, x=0, y=0, dict_color=dict_color)
        assert isinstance(result, plt.Axes)
    ...
    def test_plot_set_legend_loc_outside(self, dict_color):
        ...
        xo.plot_legend(ax=ax, loc_out=True, dict_color=dict_color)
    ...
    def test_plot_set_legend_invalid_fontsize(self, dict_color):
        ...
        ax.plot([0, 1], [0, 2], label="Sample Line")
        with pytest.raises(ValueError):
            xo.plot_legend(ax=ax, dict_color=dict_color, fontsize=-5)
    ...
    def test_plot_set_legend_invalid_marker_size(self, dict_color):
        ...
        ax.plot([0, 1], [0, 2], label="Sample Line")
        with pytest.raises(ValueError):
            xo.plot_legend(ax=ax, dict_color=dict_color, marker_size=-10)
    ...
    def test_plot_set_legend_color_and_category(self, dict_color):
        ...
        xo.plot_legend(ax=ax, dict_color=color_dict, list_cat=categories)
    ...
    def test_missing_dict_color(self):
        ...
        ax.plot(range(5))
        with pytest.raises(ValueError):
            xo.plot_legend(ax=ax, list_cat=['A'])
    ...
    def test_invalid_list_cat(self, random_cat):
        ...
        ax.plot(range(5))
        with pytest.raises(ValueError):
            xo.plot_legend(ax=ax, dict_color={'A': 'red'}, list_cat=[random_cat])
...
class TestPlotSetLegendComplex:
    ...
    def test_plot_set_legend_ncol(self, ncol):
        ...
        result = xo.plot_legend(ax=ax, ncol=int(ncol), dict_color=dict_color)
        assert isinstance(result, plt.Axes)
    ...
    def test_plot_set_legend_custom_labels(self, labels):
        fig, ax = plt.subplots()
        ax = xo.plot_legend(ax=ax, dict_color={label: "red" for label in labels})
    ...
    def test_handles_generation(self, dict_color):
        ...
        result = xo.plot_legend(ax=ax, dict_color=dict_color, list_cat=list_cat)
        assert isinstance(result, plt.Axes)
