"""
This is a script for testing the xo.plot_get_clist function.
"""
...
class TestPlotGetCList:
    ...
    def test_valid_n_colors(self, n_colors):
        colors = xo.plot_get_clist(n_colors=n_colors)
        assert len(colors) == n_colors

    def test_return_type(self):
        colors = xo.plot_get_clist(n_colors=7)
    ...
    def test_invalid_n_colors(self, n_colors):
        with pytest.raises(ValueError):
            xo.plot_get_clist(n_colors=n_colors)
